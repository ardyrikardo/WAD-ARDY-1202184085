                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <p class="card-text"><img src="pin.png" alt="" width="25" height="30">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?= $row["tempat"] ?></p>
                                    <p class="card-text"><img src="jam.png" alt="" width="30" height="30">&nbsp;&nbsp;&nbsp;&nbsp;<?= $row["mulai"] ?> - <?= $row["berakhir"] ?></p>
