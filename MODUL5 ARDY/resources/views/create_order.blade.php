        ...
        <div class="card-body">
            <form action="/order" method="POST" enctype="multipart/form-data" style="width: 1000px;">
                ...
                <div class="from-group" >
                    ...
                    <input type="text" class="form-control" id="name" name="buyer_name" placeholder="Name">
                ...
                <div class="from-group">
                    ...
                    <input type="text" class="form-control" id="contact" name="buyer_contact" placeholder="Contact">
                </div>

                <div class="from-group mb-5" style="width: 400px">
                    <label for="stock">Quantity</label>
                    <input type="number" class="form-control" id="quantity" name="amount" placeholder="Quantity">
